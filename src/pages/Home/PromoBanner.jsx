    ...
    return (
        <div className='mt-16 py-12 bg-teal-100 px-4 lg:px-24'>
            <div className='flex flex-col md:flex-row-reverse justify-between items-center gap-12'>
                ...
                {/* 2023 National Product Awards for Fiction Shortlist */}
                    <h2 className='text-4xl font-bold mb-6 leading-snug'>2023 National Product Awards for Fiction Shortlist</h2>
